...
const TopBulb02 = ({ id }) => (jsxRuntime.jsx("g", { id: id, stroke: "none", strokeWidth: "1", fill: "none", fillRule: "evenodd", children: jsxRuntime.jsxs("g", { id: "Top", fill: "#FFC107", children: [jsxRuntime.jsx("ellipse", { cx: "50", cy: "30", rx: "25", ry: "20" }), jsxRuntime.jsx("rect", { x: "45", y: "45", width: "10", height: "8" })] }) }));
const TopAntenna = ({ id }) => (jsxRuntime.jsx("g", { id: id, stroke: "none", strokeWidth: "1", fill: "none", fillRule: "evenodd", children: jsxRuntime.jsxs("g", { id: "Top", stroke: "#000000", strokeWidth: "2", children: [jsxRuntime.jsx("line", { x1: "50", y1: "0", x2: "50", y2: "30" }), jsxRuntime.jsx("circle", { cx: "50", cy: "0", r: "3", fill: "#FF0000" })] }) }));
const TopRadar = ({ id }) => (jsxRuntime.jsx("g", { id: id, stroke: "none", strokeWidth: "1", fill: "none", fillRule: "evenodd", children: jsxRuntime.jsxs("g", { id: "Top", fill: "#424242", children: [jsxRuntime.jsx("rect", { x: "40", y: "20", width: "20", height: "10", rx: "2" }), jsxRuntime.jsx("rect", { x: "48", y: "10", width: "4", height: "12" })] }) }));
// Placeholder components for other top types
const TopAntennaCrooked = ({ id }) => jsxRuntime.jsx(TopAntenna, { id: id });
const TopBulb01 = ({ id }) => jsxRuntime.jsx(TopBulb02, { id: id });
const TopGlowingBulb01 = ({ id }) => jsxRuntime.jsx(TopBulb02, { id: id });
const TopGlowingBulb02 = ({ id }) => jsxRuntime.jsx(TopBulb02, { id: id });
const TopHorns = ({ id }) => jsxRuntime.jsx(TopAntenna, { id: id });
const TopLights = ({ id }) => jsxRuntime.jsx(TopBulb02, { id: id });
const TopPlankton = ({ id }) => jsxRuntime.jsx(TopAntenna, { id: id });
const TopPyramid = ({ id }) => jsxRuntime.jsx(TopRadar, { id: id });
const topComponents = {
    Antenna: TopAntenna,
...
function Top() {
    ...
    return jsxRuntime.jsx(TopComponent, { id: `Top/${topType}` });
}
